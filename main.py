'''from xu_ly_kho import them_san_pham, xoa_san_pham, cap_nhat_san_pham, tim_kiem_san_pham, hien_thi
...
def menu():
    ...
    while True:
        print("\n" + "=" * 45)
        print("     CHƯƠNG TRÌNH QUẢN LÝ KHO HÀNG")
        print("=" * 45)
        print("| {:<2} | {:<35} |".format("1", "Thêm sản phẩm"))
        print("| {:<2} | {:<35} |".format("2", "Xóa sản phẩm theo mã"))
        print("| {:<2} | {:<35} |".format("3", "Cập nhật sản phẩm"))
        print("| {:<2} | {:<35} |".format("4", "Tìm kiếm theo tên"))
        print("| {:<2} | {:<35} |".format("5", "Hiển thị danh sách"))
        print("| {:<2} | {:<35} |".format("6", "Lưu vào file"))
        print("| {:<2} | {:<35} |".format("0", "Thoát"))
        print("=" * 45)

        chon = input("Nhập lựa chọn (0-6): ").strip()
        ...
        if chon == "1":
            ...
            tu_khoa = input("Từ khóa tên sản phẩm: ")
...
from xu_ly_kho import (
    them_san_pham, xoa_san_pham, cap_nhat_san_pham,
    tim_kiem_san_pham, hien_thi, hien_thi_theo_loai
)
from doc_ghi_file import doc_file, luu_file
...
def menu():
    ...
    while True:
        ...
        print("      CHƯƠNG TRÌNH QUẢN LÝ KHO HÀNG")
        print("=" * 50)
        print("| {:<2} | {:<40} |".format("1", "Thêm sản phẩm"))
        print("| {:<2} | {:<40} |".format("2", "Xóa sản phẩm theo mã"))
        print("| {:<2} | {:<40} |".format("3", "Cập nhật sản phẩm"))
        print("| {:<2} | {:<40} |".format("4", "Tìm kiếm theo tên"))
        print("| {:<2} | {:<40} |".format("5", "Hiển thị danh sách"))
        print("| {:<2} | {:<40} |".format("6", "Lưu vào file"))
        print("| {:<2} | {:<40} |".format("7", "Hiển thị theo danh mục"))
        print("| {:<2} | {:<40} |".format("0", "Thoát"))
        print("=" * 50)

        chon = input("Nhập lựa chọn (0-7): ").strip()
